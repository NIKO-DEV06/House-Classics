...
const GalleryLink = ({ heading, imgSrc, subtext, href }: GalleryLinkProps) => {
  return (
    <Link href={href}>
      ...
      >
        <div className="flex items-center gap-[2rem] md:gap-[2.5rem] pl-[2rem] pr-[2rem]  md:pl-[4rem] md:pr-[4rem] lg:pl-[6rem] lg:pr-[10rem]">
        ...
        <div className="w-full flex items-center justify-between border-[#2B2B2B] border-b-[1px] py-[1.5rem] bg-[#FFE81F] absolute text-black pl-[2rem] pr-[2rem] md:pl-[4rem] md:pr-[4rem] lg:pl-[6rem] lg:pr-[10rem] scale-y-0 group-hover:scale-y-100 duration-[350ms] ease-in-out">
