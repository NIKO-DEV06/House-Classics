...
const GalleryLink = ({ heading, imgSrc, subtext, href }: GalleryLinkProps) => {
  return (
    <Link href={href}>
      ...
      >
        <div className="flex items-center gap-[2rem] md:gap-[2.5rem] pl-[1.3rem] pr-[1.3rem] md:pl-[4rem] md:pr-[4rem] lg:pl-[6rem] lg:pr-[10rem] 2xl:w-[1600px] 2xl:m-auto">
        ...
        <div className="w-full flex items-center justify-between py-[1.5rem] bg-[#FFE81F] absolute text-black scale-y-0 group-hover:scale-y-100 duration-[350ms] ease-in-out">
          <div className="flex gap-[2rem] md:gap-[2.5rem] pl-[1.3rem] pr-[1.3rem] md:pl-[4rem] md:pr-[4rem] lg:pl-[6rem] lg:pr-[10rem] 2xl:w-[1600px] 2xl:m-auto">
        ...
        <motion.div
          ...
          className="absolute top-[-7rem] right-[15rem] z-0 rounded-lg object-cover lg:h-[15rem] lg:w-[18rem] hidden lg:block 2xl:w-[1600px] 2xl:m-auto 2xl:right-[-50rem]"
        >
